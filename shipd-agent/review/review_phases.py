# Review phases — deterministic Phase 0 execution (artifact, patch, and
# test.sh verification) plus phase_results merging helpers for phases 0-6.
...
# --- phase_results merging helpers (phases 0-6) ---
